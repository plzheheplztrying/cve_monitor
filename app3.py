...
def write_html(cve_data):
    """Generates the CVE HTML report with a warm yellow background (blue light filter effect)."""
    html_content = """
    <html lang="en">
    <head>
        <meta charset="UTF-8">
        ...
        <style>
            body {
                background-color: #fffbe6; /* warm light yellow */
                color: #212529;
            }
            .container {
                max-width: 95%;
            ...
            .table-hover tbody tr:hover {
                background-color: #fff2cc; /* very light warm hover */
            }
        </style>
    </head>
    <body>
